      ...
      <div className="print-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="delivery-label">
          <div className="label-header">
            ...
            <div className="tracking-info">
              <div className="tracking-number">
                <strong>Tracking #:</strong> {delivery.tracking_code || `FD${delivery.id}${Math.floor(Math.random() * 10000)}`}
              </div>
              <div className="barcode">
                *{delivery.tracking_code || `FD${delivery.id}${Math.floor(Math.random() * 10000)}`}*
              </div>
            </div>
          </div>
          ...
          <div className="label-body">
            <div className="label-section">
              ...
              <div className="address-block">
                ...
                <p><strong>Contact:</strong> {delivery.contact_number}</p>
              </div>
            </div>
            ...
            <div className="label-section">
              ...
              <div className="qr-code">
                <img 
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=100x100&data=${delivery.tracking_code || `FD${delivery.id}`}`} 
                  alt="QR Code"
                />
              </div>
          ...
          <div className="label-footer">
            <p>Thank you for shipping with FastDelivery! For customer service, please call +1-800-FAST-DEL</p>
            <p>Order #: {delivery.id} • Processed on {formatDate(delivery.created_at)}</p>
          </div>
        </div>
      </div>
    </div>
