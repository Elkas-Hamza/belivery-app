...
import { FiPackage, FiClock, FiTruck, FiCheck, FiX, FiPlus, FiRefreshCw, FiMapPin } from 'react-icons/fi';
    ...
    <div className="dashboard-container">
      <div className="dashboard-header">
        <div className="dashboard-title">
          <h1>Dashboard</h1>
          <p className="dashboard-subtitle">Track and manage your deliveries in one place</p>
        </div>
        <div className="dashboard-actions">
          <button className="refresh-button" onClick={fetchDashboardData}>
            <FiRefreshCw /> Refresh
          </button>
          <button className="create-delivery-button" onClick={handleCreateDelivery}>
            <FiPlus /> New Delivery
          </button>
        </div>
      </div>
      ...
      <div className="dashboard-content">
          ...
          <div className="analytics-grid">
            <div className="analytics-card">
              ...
              <div className="analytics-content">
                ...
                <div className="analytics-value">${stats.analytics.totalSpent.toFixed(2)}</div>
                <div className="analytics-description">Total amount spent on deliveries</div>
              </div>
            </div>
            ...
            <div className="analytics-card">
              ...
              <div className="analytics-content">
                ...
                <div className="analytics-value">
                  {stats.analytics.avgDeliveryTime ? `${stats.analytics.avgDeliveryTime} hours` : 'N/A'}
                </div>
                <div className="analytics-description">Average time from order to delivery</div>
              </div>
            </div>
              ...
              <div className="analytics-content">
                ...
                <div className="analytics-value">
                  {stats.analytics.mostCommonDestination ? (
                    <div className="address-truncate">{stats.analytics.mostCommonDestination}</div>
                  ) : 'N/A'}
                </div>
                <div className="analytics-description">Your most frequent delivery location</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="dashboard-section">
          <div className="section-header">
            ...
            <a href="#/deliveries" className="view-all-link">View all</a>
          </div>
                  ...
                  <div className="delivery-route">
                    <div className="route-point pickup">
                      ...
                      <div className="point-details">
                        ...
                        <div className="point-address">{delivery.pickup_address}</div>
                      </div>
                    </div>
                    ...
                    <div className="route-point delivery">
                      ...
                      <div className="point-details">
                        ...
                        <div className="point-address">{delivery.delivery_address}</div>
                      </div>
                    </div>
                  </div>
